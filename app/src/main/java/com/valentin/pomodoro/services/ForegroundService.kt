package com.valentin.pomodoro.services
...
import com.valentin.pomodoro.MainActivity
...
class ForegroundService : Service() {
    ...
    private var TAG = "ForegroundService2"
    ...
    private fun continueTimer(startTime: Long) {
        ...
        timer?.cancel()
        timer = getCountDownTimer(startTime)
        timer?.start()
//
...
//        }
    ...
    private fun getCountDownTimer(time: Long): CountDownTimer {
        Log.d(TAG, "Time: $time")
